            ...
            <div class="flex items-center justify-center gap-2">
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        class="h-4 w-4 transition-transform duration-200 ease-in-out {{ auth()->check() && $post->reactions && $post->reactions->where('user_id', auth()->id())->count() > 0 ? 'scale-110' : 'scale-100' }}" 
