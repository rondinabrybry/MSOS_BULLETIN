<?php if($paginator->hasPages()): ?>
    <nav role="navigation" aria-label="<?php echo e(__('Pagination Navigation')); ?>" class="flex items-center justify-between">
        ...
        <div class="paginated hidden flex flex-col justify-between sm:flex-1 sm:flex sm:items-center sm:justify-between">
            
            <div class="how-many mb-2">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\LARAVEL\BULLETIN\bulletin\resources\views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>